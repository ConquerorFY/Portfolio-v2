...
const renderContent = {
    ...
    2: (
        <InfoBox
            text="Worked with multiple individuals and companies while picking up many useful skills"
            link="/about"
    ...
    3: (
        <InfoBox
            text="Worked on multiple projects throughout the years. Curious about them?"
            link="/projects"
